...
export const ALL_SKILLS: Skill[] = [
  ...
  { id: 'skill-coach', title: 'Skill Coach', category: 'Orchestration & Meta', path: '/docs/skills/skill_coach', description: getDesc('skill-coach', 'Guide for creating high-quality Agent Skills with domain expertise, anti-pattern detection, and progressive disclosure.'), tags: ['coaching', 'validation', 'beginner-friendly'] },
  ...
  { id: 'swift-executor', title: 'Swift Executor', category: 'Orchestration & Meta', path: '/docs/skills/swift_executor', description: getDesc('swift-executor', 'Rapid task execution without hesitation. Overcomes blockers through pragmatic solutions. Ships and iterates.'), tags: ['automation', 'production-ready'] },
  ...
  { id: 'windows-3-1-web-designer', title: 'Windows 3.1 Web Designer', category: 'Visual Design & UI', path: '/docs/skills/windows_3_1_web_designer', description: getDesc('windows-3-1-web-designer', 'Authentic Windows 3.1 aesthetic for modern web. Beveled borders, system gray, pixel fonts.'), tags: ['creation', 'design', 'visual', 'code'] },
  ...
  { id: 'vibe-matcher', title: 'Vibe Matcher', category: 'Visual Design & UI', path: '/docs/skills/vibe_matcher', description: getDesc('vibe-matcher', 'Synesthete designer that translates emotional vibes and brand keywords into concrete visual DNA.'), tags: ['analysis', 'creation', 'design', 'data', 'beginner-friendly'] },
  { id: 'interior-design-expert', title: 'Interior Design Expert', category: 'Visual Design & UI', path: '/docs/skills/interior_design_expert', description: getDesc('interior-design-expert', 'Expert interior designer with color science (Munsell), IES lighting standards, and computational space planning.'), tags: ['creation', 'design', 'spatial', 'visual', 'advanced'] },
  { id: 'design-archivist', title: 'Design Archivist', category: 'Visual Design & UI', path: '/docs/skills/design_archivist', description: getDesc('design-archivist', 'Long-running design anthropologist that builds comprehensive visual databases from 500-1000 real-world examples.'), tags: ['research', 'design', 'data', 'advanced'] },
  ...
  { id: 'rope-physics-rendering-expert', title: 'Rope Physics + Rendering', category: 'Graphics, 3D & Simulation', path: '/docs/skills/physics_rendering_expert', description: getDesc('physics-rendering-expert', 'Real-time rope and cable dynamics simulation with constraint solvers and rendering.'), tags: ['creation', '3d', 'code', 'advanced'] },
  { id: 'collage-layout-expert', title: 'Collage Layout Expert', category: 'Graphics, 3D & Simulation', path: '/docs/skills/collage_layout_expert', description: getDesc('collage-layout-expert', 'Expert in computational collage composition inspired by David Hockney joiners.'), tags: ['creation', 'cv', 'photography', 'visual', 'advanced'] },
  ...
  { id: 'drone-cv-expert', title: 'Drone CV Expert', category: 'Autonomous Systems & Robotics', path: '/docs/skills/drone_cv_expert', description: getDesc('drone-cv-expert', 'Expert in drone systems, computer vision, and autonomous navigation.'), tags: ['creation', 'robotics', 'cv', 'code', 'advanced'] },
  { id: 'drone-inspection-specialist', title: 'Drone Inspection Specialist', category: 'Autonomous Systems & Robotics', path: '/docs/skills/drone_inspection_specialist', description: getDesc('drone-inspection-specialist', 'Advanced CV for infrastructure inspection including thermal analysis and 3D reconstruction.'), tags: ['analysis', 'robotics', 'cv', '3d', 'advanced'] },

  // 💬 Conversational AI & Bots (1 skill)
  { id: 'bot-developer', title: 'Bot Developer', category: 'Conversational AI & Bots', path: '/docs/skills/bot_developer', description: getDesc('bot-developer', 'Production-grade bot development for Discord, Telegram, Slack with state machines, rate limiting, and moderation systems.'), tags: ['creation', 'automation', 'code', 'production-ready'] },
  ...
  { id: 'career-biographer', title: 'Career Biographer', category: 'Coaching & Personal Development', path: '/docs/skills/career_biographer', description: getDesc('career-biographer', 'AI-powered career biographer that conducts empathetic interviews and transforms professional stories into portfolios, CVs, and personal brand assets.'), tags: ['coaching', 'career', 'document', 'beginner-friendly'] },
  { id: 'cv-creator', title: 'CV Creator', category: 'Coaching & Personal Development', path: '/docs/skills/cv_creator', description: getDesc('cv-creator', 'Professional resume builder that transforms career narratives into ATS-optimized, multi-format resumes with strategic positioning.'), tags: ['creation', 'career', 'document', 'beginner-friendly', 'production-ready'] },
  { id: 'personal-finance-coach', title: 'Personal Finance Coach', category: 'Coaching & Personal Development', path: '/docs/skills/personal_finance_coach', description: getDesc('personal-finance-coach', 'Expert personal finance coach grounded in academic research: MPT, factor investing, tax optimization, and retirement mathematics.'), tags: ['coaching', 'finance', 'analysis', 'beginner-friendly'] },
  ...
  { id: 'site-reliability-engineer', title: 'Site Reliability Engineer', category: 'DevOps & Site Reliability', path: '/docs/skills/site_reliability_engineer', description: getDesc('site-reliability-engineer', 'Proactive validation and build reliability expert that prevents SSG failures through pre-commit hooks, MDX validation, and systematic error detection.'), tags: ['validation', 'automation', 'devops', 'code', 'production-ready'] },
];
