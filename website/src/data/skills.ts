...
export const ALL_SKILLS: Skill[] = [
  ...
  { id: 'mcp-creator', title: 'MCP Creator', category: 'Orchestration & Meta', path: '/docs/skills/mcp_creator', description: getDesc('mcp-creator', 'Expert MCP server developer creating safe, performant, production-ready servers with proper security, error handling, and developer experience.'), tags: ['creation', 'code', 'mcp', 'devops', 'production-ready'], badge: 'NEW' },
