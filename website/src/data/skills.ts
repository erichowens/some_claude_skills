...
export const ALL_SKILLS: Skill[] = [
  ...
  { id: 'windows-3-1-web-designer', title: 'Windows 3.1 Web Designer', category: 'Visual Design & UI', path: '/docs/skills/windows_3_1_web_designer', description: getDesc('windows-3-1-web-designer', 'Authentic Windows 3.1 aesthetic for modern web. Beveled borders, system gray, pixel fonts.') },
