...
exports.default = BundleQuickView;
 ...
 */
function BundleQuickView(_a) {
    var bundle = _a.bundle, onClose = _a.onClose, onViewSkill = _a.onViewSkill;
    ...
    var copyInstallCommand = (0, react_1.useCallback)(function () {
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              {requiredSkills.map(function (skill) { return (<div key={skill.id} style={{
                display: 'flex',
                ...
                border: '1px solid #ccc',
                  ...
                  <div style={{ flex: 1 }}>
                    <button onClick={function () { return onViewSkill === null || onViewSkill === void 0 ? void 0 : onViewSkill(skill.id); }} style={{
                background: 'none',
                border: 'none',
                padding: 0,
            ...
            {optionalSkills.length > 0 && (<>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  {optionalSkills.map(function (skill) { return (<div key={skill.id} style={{
                    display: 'flex',
                    alignItems: 'flex-start',
                    gap: '8px',
                    padding: '4px 8px',
          ...
          {/* Use Cases */}
          {bundle.useCases && bundle.useCases.length > 0 && (<div style={{ marginBottom: '16px' }}>
              <h4 style={{
                margin: '0 0 8px 0',
                fontSize: '13px',
                fontFamily: 'var(--font-system)',
              ...
              <ul style={{
                ...
                {bundle.useCases.map(function (useCase, i) { return (<li key={i} style={{ color: '#333' }}>
                    {useCase}
                  </li>); })}
              </ul>
            </div>)}
          ...
          {/* Tags */}
          {bundle.tags && bundle.tags.length > 0 && (<div>
              <TagBadge_1.TagList tags={bundle.tags.filter(function (t) { return t !== 'featured'; })} size="sm"/>
            </div>)}
        </div>
