    ...
    return (<div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '20px' }}>
          ...
          {/* Pairs Great With */}
          {skill.pairsWith && skill.pairsWith.length > 0 && (<div style={{
                marginBottom: '16px',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {skill.pairsWith.map(function (pairing, idx) {
                var pairedSkill = skills_1.skills.find(function (s) { return s.id === pairing.skill; });
                if (!pairedSkill)
                    return null;
                return (<a key={idx} href={(0, useBaseUrl_1.default)(pairedSkill.path)} style={{
                        textDecoration: 'none',
                        display: 'flex',
