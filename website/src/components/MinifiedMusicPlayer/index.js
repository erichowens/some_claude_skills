...
function MinifiedMusicPlayer() {
    ...
    var _f = (0, react_1.useState)('classic'), currentSkin = _f[0], setCurrentSkin = _f[1];
    var _g = (0, react_1.useState)(false), showSkinMenu = _g[0], setShowSkinMenu = _g[1];
    var skins = [
    ...
    var _h = (0, react_1.useState)(progress), displayProgress = _h[0], setDisplayProgress = _h[1];
    ...
    //   : {};
    return (<div ref={playerRef} className={"".concat(styles_module_css_1.default.winampShade, " ").concat(hasInteracted ? styles_module_css_1.default.interacted : '', " ").concat(styles_module_css_1.default["skin_".concat(currentSkin)] || '')}>
      ...
      <div className={styles_module_css_1.default.titleGrip} onDoubleClick={handleGripDoubleClick} title="Double-click for surprise">
