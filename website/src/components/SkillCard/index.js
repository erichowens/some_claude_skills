...
function SkillCard(_a) {
    ...
    return (<div className={styles_module_css_1.default.skillCard}>
      {skill.heroImage && (<div className={styles_module_css_1.default.heroImageContainer}>
          <img src={skill.heroImage} alt={"".concat(skill.title, " hero image")} className={styles_module_css_1.default.heroImage} loading="lazy"/>
        </div>)}
