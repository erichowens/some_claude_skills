...
function fetchPlausibleStats() {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, siteId, url, response, data, stats, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!apiKey) {
                        ...
                        return [2 /*return*/, generateMockStats()];
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                ...
                case 3:
                    data = _a.sent();
                    stats = data.results.map(function (result) { return ({
                        skillId: result.dimension,
                        views: result.visitors,
                        lastUpdated: new Date().toISOString(),
                    }); });
                    console.log("\u2705 Fetched stats for ".concat(stats.length, " skills"));
