---
sidebar_label: Partner Text Coach
sidebar_position: 1
---
...
`relationships` `communication` `nvc` `conflict` `attachment`

## 🤝 Pairs Great With

- **[Jungian Psychologist](/docs/skills/jungian_psychologist)**: Deep psychological context
- **[Wisdom Accountability Coach](/docs/skills/wisdom_accountability_coach)**: Relationship growth tracking

## References

- [Attachment Styles in Relationships](./references/attachment-styles)
