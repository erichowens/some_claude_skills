---
sidebar_label: Dag Pattern Learner
sidebar_position: 1
---
...
`dag` `observability` `learning` `patterns` `optimization`

## 🤝 Pairs Great With

- **[Dag Execution Tracer](/docs/skills/dag_execution_tracer)**: Source of execution data
- **[Dag Performance Profiler](/docs/skills/dag_performance_profiler)**: Source of performance data
- **[Dag Failure Analyzer](/docs/skills/dag_failure_analyzer)**: Source of failure patterns
- **[Dag Graph Builder](/docs/skills/dag_graph_builder)**: Applies learned patterns
