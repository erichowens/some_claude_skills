---
sidebar_label: Web Design Expert
sidebar_position: 1
---
...
```
Read, Write, Edit, WebFetch, mcp__magic__21st_magic_component_builder, mcp__magic__21st_magic_component_inspiration, mcp__magic__21st_magic_component_refiner, mcp__magic__logo_search
```
...
- **[Typography Expert](/docs/skills/typography_expert)**: Typography for web designs
- **[Color Theory Palette Harmony Expert](/docs/skills/color_theory_palette_harmony_expert)**: Color palettes for web

## References

- [Color & Accessibility](./references/color-accessibility)
- [Layout Systems](./references/layout-systems)
- [Design Tooling Integration](./references/tooling-integration)
