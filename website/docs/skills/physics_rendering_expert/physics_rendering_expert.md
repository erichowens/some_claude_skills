---
sidebar_label: Physics Rendering Expert
sidebar_position: 1
---
...
`physics` `pbd` `verlet` `simulation` `constraints`

## 🤝 Pairs Great With

- **[Metal Shader Expert](/docs/skills/metal_shader_expert)**: GPU-accelerated physics rendering
- **[Native App Designer](/docs/skills/native_app_designer)**: Physics in app animations

## References

- [Core Physics Algorithms](./references/core-algorithms)
- [Physics Implementation Reference](./references/implementations)
- [Knot Garden Physics](./references/knot-garden-physics)
- [Tangle Physics](./references/tangle-physics)
