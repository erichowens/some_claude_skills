---
sidebar_label: Dag Context Bridger
sidebar_position: 1
---
...
`dag` `orchestration` `context` `summarization` `token-management`

## 🤝 Pairs Great With

- **[Dag Parallel Executor](/docs/skills/dag_parallel_executor)**: Provides context to spawned agents
- **[Dag Result Aggregator](/docs/skills/dag_result_aggregator)**: Receives context from aggregated results
- **[Dag Performance Profiler](/docs/skills/dag_performance_profiler)**: Tracks context token usage
