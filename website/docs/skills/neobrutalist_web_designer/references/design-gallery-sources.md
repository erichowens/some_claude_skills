...
**Author**: Samuel Breznjak (@samuelbreznjak)
...
**URL**: https://www.behance.net/gallery/164728311/How-can-I-design-in-the-Neo-Brutalism-style
**Author**: Sepideh Yazdi (@sepidy)
**Published**: February 26, 2023
**Stats**: 499 appreciations, 10.2K views

#### Cheat Sheet Summary

**COLOR RULES**:
1. **Black**: Use pitch black with no fear! Two main uses:
   - Strokes (borders)
   - Dark shadows
...
- **Recommended fonts**:
  ...
  - [Mabry Pro](https://en.bestfonts.pro/font/mabry-pro)
  - [Archivo Black](https://fonts.google.com/specimen/Archivo+Black)
  - [Bebas Kai](https://www.dafont.com/bebas-kai.font)
...
**URL**: https://freefrontend.com/css-neobrutalism/
**Examples**: 6 curated CSS implementations
...
1. **Neobrutalist Subscribe Form** (January 2026)
   ...
   - **CodePen**: [rustcode collection](https://codepen.io/rustcode/pen/MYYMrVQ)
...
4. **Bootstrap 5 Accordion Example**
   - Uses `:has()` pseudo-class for active panel detection
   - Applies bold border and hard shadow to parent container
   - Creates "pop-out" focus effect

5. **Credit Card Checkout**
   - JS-free form component
   - Solid `border` with hard, offset `box-shadow`
   - Tactile, pseudo-3D effect
   - Flexbox layout
   - `box-shadow` outline on `:hover`
   - Background change on `:focus`

**Related CSS Hubs**:
- [CSS box-shadow Examples](https://freefrontend.com/css-box-shadow-examples/)
- [CSS Forms](https://freefrontend.com/css-forms/)
- [CSS :has() Examples](https://freefrontend.com/css-has/)
...
**Stats**: 60 components, 95 design systems, 2,680 examples
...
1. https://www.behance.net/gallery/164728311/How-can-I-design-in-the-Neo-Brutalism-style (Main guide)
2. https://www.behance.net/gallery/141541363/Neo-brutalism-landing-page-UI-design
3. https://www.behance.net/gallery/164756593/NEO-BRUTALISM-Concept-NFT-Website-Design
