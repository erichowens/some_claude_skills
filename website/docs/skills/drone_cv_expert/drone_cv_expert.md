...
```
Read, Write, Edit, Bash(python:*, pip:*), Grep, Glob, mcp__firecrawl__firecrawl_search, WebFetch
```

## Tags

`drone` `slam` `navigation` `sensor-fusion` `path-planning`

## 🤝 Pairs Great With

- **[Drone Inspection Specialist](/docs/skills/drone_inspection_specialist)**: Domain-specific inspection tasks
- **[Physics Rendering Expert](/docs/skills/physics_rendering_expert)**: Physics simulation for drone systems

## References

- [Navigation Algorithms Reference](./references/navigation-algorithms)
- [Object Detection & Tracking Reference](./references/object-detection-tracking)
- [Sensor Fusion & State Estimation Reference](./references/sensor-fusion-ekf)
