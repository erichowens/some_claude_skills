...
- [Animation Patterns for Water Effects](./references/animation-patterns)
- [feDisplacementMap and Color Techniques for Water](./references/displacement-and-color)
- [feTurbulence Deep Dive for Water Effects](./references/turbulence-deep-dive)
