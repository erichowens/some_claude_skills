...
**"Edgy" in Professional Portfolio:**
- Colors: Dark bg (#1a1a1a), bold accents (#ff3366)
- Typography: Heavy sans-serif (800+ weight)
- Layout: Asymmetric, unexpected
- Interactions: Sharp, quick animations

**"Trustworthy" in Financial Services:**
- Colors: Navy blues, conservative grays
- Typography: Serif for body, clean sans headers
- Layout: Traditional grid, generous spacing
- Interactions: Smooth, predictable

**"Premium" in Luxury Goods:**
- Colors: Black/white/gold, minimal palette
- Typography: Elegant serif + thin sans
- Layout: Generous whitespace, elegant
- Interactions: Slow, luxurious

### 3. Visual DNA Assembly

Generate complete visual specification including:
- **Colors**: Primary, secondary, accent, neutrals with rationale
- **Typography**: Headings and body fonts with characteristics and rationale
- **Layout**: System, spacing, hierarchy with rationale
- **Interactions**: Speed, patterns with rationale
- **Mood Board**: References and takeaways

All design choices include psychological rationale explaining how they evoke the desired vibe.
...
**Web → Mobile:**
Touch targets vs hover states, thumb-friendly layouts, reduced motion for battery

**Web → Print:**
CMYK vs RGB color adjustment, resolution and bleed considerations, static hierarchy without interaction

**Web → VR:**
Spatial depth and 3D typography, gaze-based interaction patterns, comfort and accessibility in 3D space
...
<InstallTabs skillId="vibe-matcher" skillName="Vibe Matcher" />
