---
sidebar_label: Wedding Immortalist
sidebar_position: 1
---
...
`wedding` `3dgs` `gaussian-splatting` `face-clustering` `memories`

## 🤝 Pairs Great With

- **[Photo Content Recognition Curation Expert](/docs/skills/photo_content_recognition_curation_expert)**: Curate wedding photos
- **[Event Detection Temporal Intelligence Expert](/docs/skills/event_detection_temporal_intelligence_expert)**: Detect wedding events

## References

- [Face Clustering & Aesthetic Photo Selection](./references/face-clustering-aesthetics)
- [3D Gaussian Splatting Pipeline for Weddings](./references/gaussian-splatting-pipeline)
- [Wedding Theme Extraction & Design System](./references/theme-extraction)
