---
sidebar_label: Dag Parallel Executor
sidebar_position: 1
---
...
`dag` `orchestration` `parallel-execution` `concurrency` `task-tool`

## 🤝 Pairs Great With

- **[Dag Task Scheduler](/docs/skills/dag_task_scheduler)**: Receives execution schedule
- **[Dag Result Aggregator](/docs/skills/dag_result_aggregator)**: Sends results for aggregation
- **[Dag Context Bridger](/docs/skills/dag_context_bridger)**: Bridges context between agents
