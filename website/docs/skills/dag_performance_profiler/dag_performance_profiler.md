---
sidebar_label: Dag Performance Profiler
sidebar_position: 1
---
...
`dag` `observability` `performance` `metrics` `optimization`

## 🤝 Pairs Great With

- **[Dag Execution Tracer](/docs/skills/dag_execution_tracer)**: Uses execution traces
- **[Dag Failure Analyzer](/docs/skills/dag_failure_analyzer)**: Performance-related failures
- **[Dag Pattern Learner](/docs/skills/dag_pattern_learner)**: Provides performance patterns
- **[Dag Task Scheduler](/docs/skills/dag_task_scheduler)**: Scheduling optimization
