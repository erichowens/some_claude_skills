---
sidebar_label: Digital Estate Planner
sidebar_position: 1
---
...
`legacy` `passwords` `estate` `death-preparedness` `digital-assets`

## 🤝 Pairs Great With

- **[Grief Companion](/docs/skills/grief_companion)**: Support for end-of-life planning
- **[Security Auditor](/docs/skills/security_auditor)**: Ensure secure estate documentation

## References

- [Digital Account Inventory Template](./references/account-inventory-template)
