---
sidebar_label: Win31 Pixel Art Designer
sidebar_position: 1
---
...
```
Read, Write, Edit, Bash(convert:*, magick:*), mcp__ideogram__generate_image, mcp__stability-ai__*
```

## Tags

`pixel-art` `icons` `retro` `windows` `90s` `dithering`

## 🤝 Pairs Great With

- **[Windows 3 1 Web Designer](/docs/skills/windows_3_1_web_designer)**: Visual + CSS Win31 experience
- **[Win31 Audio Design](/docs/skills/win31_audio_design)**: Complete retro multimedia
- **[Pixel Art Infographic Creator](/docs/skills/pixel_art_infographic_creator)**: Diagrams and educational graphics
