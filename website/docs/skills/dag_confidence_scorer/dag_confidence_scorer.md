---
sidebar_label: Dag Confidence Scorer
sidebar_position: 1
---
...
`dag` `quality` `confidence` `scoring` `reliability`

## 🤝 Pairs Great With

- **[Dag Output Validator](/docs/skills/dag_output_validator)**: Scores validated outputs
- **[Dag Hallucination Detector](/docs/skills/dag_hallucination_detector)**: Low confidence triggers detection
- **[Dag Iteration Detector](/docs/skills/dag_iteration_detector)**: Low confidence may require iteration
