---
sidebar_label: Photo Composition Critic
sidebar_position: 1
---
...
```
Read, Write, Edit, Bash, mcp__firecrawl__firecrawl_search
```

## Tags

`photography` `composition` `aesthetics` `nima` `critique`

## 🤝 Pairs Great With

- **[Color Theory Palette Harmony Expert](/docs/skills/color_theory_palette_harmony_expert)**: Color analysis of photos
- **[Collage Layout Expert](/docs/skills/collage_layout_expert)**: Quality photos for collages

## References

- [Analysis Scripts](./references/analysis-scripts)
- [Color Theory](./references/color-theory)
- [Composition Theory](./references/composition-theory)
- [Computational Aesthetics Models](./references/ml-models)
