...
`seo` `llms-txt` `discoverability` `product-hunt` `aeo`

## 🤝 Pairs Great With

- **[Claude Ecosystem Promoter](/docs/skills/claude_ecosystem_promoter)**: Promote with SEO backing
- **[Technical Writer](/docs/skills/technical_writer)**: SEO-optimized documentation

## References

- [Launch Checklists](./references/launch-checklists)
- [llms.txt Examples](./references/llms-txt-examples)
- [JSON-LD Schema Templates](./references/schema-templates)
