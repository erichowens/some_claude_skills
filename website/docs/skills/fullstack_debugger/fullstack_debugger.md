---
sidebar_label: Fullstack Debugger
sidebar_position: 1
---
...
```
Read, Write, Edit, Bash, Grep, Glob, WebFetch, mcp__supabase__*, mcp__playwright__*
```

## Tags

`debugging` `nextjs` `cloudflare-workers` `supabase` `troubleshooting`

## 🤝 Pairs Great With

- **[Devops Automator](/docs/skills/devops_automator)**: Deployment and infrastructure issues
- **[Site Reliability Engineer](/docs/skills/site_reliability_engineer)**: Production incidents

## References

- [Debug Decision Tree](./references/debug-decision-tree)
- [Common Error Patterns & Solutions](./references/error-patterns)
