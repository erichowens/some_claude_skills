---
sidebar_label: Metal Shader Expert
sidebar_position: 1
---
...
```
Read, Write, Edit, Bash(xcrun:*, metal:*, metallib:*), mcp__firecrawl__firecrawl_search, WebFetch
```
...
- **[Native App Designer](/docs/skills/native_app_designer)**: GPU-accelerated iOS/Mac apps
- **[2000s Visualization Expert](/docs/skills/2000s_visualization_expert)**: Advanced shader techniques

## References

- [Debug Tools & Visualization](./references/debug-tools)
- [Noise-Based Effects](./references/noise-effects)
- [PBR Shader Implementation](./references/pbr-shaders)
