...
SOURCE: SAMHSA, National Institute on Drug Abuse
```
...
└── Need to rebuild from a new foundation
```
...
└── Person in recovery is stabilized
```
...
└── Deeper relational work desired
```
...
└── Both partners are communicators
```
...
└── Individual therapy only (not couples-trained)
```
...
6. "What can we expect in terms of progress/timeline?"
   Look for: Realistic expectations, not quick fixes
```
...
└── Can be more affordable, but check credentials
```
...
└── Hope from others who've been there
```

## The Conversation: Asking for Couples Therapy
...
│   And my addiction affected both of us."
```
