---
sidebar_label: Native App Designer
sidebar_position: 1
---
...
- **[Metal Shader Expert](/docs/skills/metal_shader_expert)**: GPU-accelerated visual effects
- **[Vaporwave Glassomorphic Ui Designer](/docs/skills/vaporwave_glassomorphic_ui_designer)**: Aesthetic iOS design

## References

- [Custom Shaders for Unique Effects](./references/custom-shaders)
- [React/JavaScript Design Patterns](./references/react-patterns)
- [SwiftUI Design Patterns](./references/swiftui-patterns)
