---
sidebar_label: Dag Output Validator
sidebar_position: 1
---
...
`dag` `quality` `validation` `schemas` `outputs`

## 🤝 Pairs Great With

- **[Dag Confidence Scorer](/docs/skills/dag_confidence_scorer)**: Provides validated output for scoring
- **[Dag Hallucination Detector](/docs/skills/dag_hallucination_detector)**: Works together on quality checks
- **[Dag Result Aggregator](/docs/skills/dag_result_aggregator)**: Validates before aggregation
