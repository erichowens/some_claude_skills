...
- [Cloud Animation Patterns](./references/animation-patterns)
- [Cloud Color and Lighting Guide](./references/color-and-lighting)
- [SVG Filter Deep Dive for Cloud Effects](./references/svg-filter-deep-dive)
