...
`job-search` `ats` `resume-seo` `application` `optimization`

## 🤝 Pairs Great With

- **[Cv Creator](/docs/skills/cv_creator)**: Generate optimized CVs
- **[Competitive Cartographer](/docs/skills/competitive_cartographer)**: Understand job market positioning
