---
sidebar_label: Panic Room Finder
sidebar_position: 1
---
...
`hidden-rooms` `architecture` `investigation` `safe-room` `mapping`

## 🤝 Pairs Great With

- **[Interior Design Expert](/docs/skills/interior_design_expert)**: Integrate hidden spaces into design
- **[Diagramming Expert](/docs/skills/diagramming_expert)**: Map discovered spaces

## References

- [House Measurement Templates](./references/measurement-templates)
