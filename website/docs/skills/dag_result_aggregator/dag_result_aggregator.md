---
sidebar_label: Dag Result Aggregator
sidebar_position: 1
---
...
`dag` `orchestration` `aggregation` `merge` `fan-in`

## 🤝 Pairs Great With

- **[Dag Parallel Executor](/docs/skills/dag_parallel_executor)**: Receives results from parallel execution
- **[Dag Output Validator](/docs/skills/dag_output_validator)**: Validates aggregated results
- **[Dag Context Bridger](/docs/skills/dag_context_bridger)**: Bridges aggregated context forward
