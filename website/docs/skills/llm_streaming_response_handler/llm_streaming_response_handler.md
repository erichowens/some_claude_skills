---
sidebar_label: Llm Streaming Response Handler
sidebar_position: 1
---
...
- [Server-Sent Events (SSE) Protocol](./references/sse-protocol)
- [Vercel AI SDK Integration Patterns](./references/vercel-ai-sdk)
