---
sidebar_label: Win31 Audio Design
sidebar_position: 1
---
...
```
Read, Write, Edit, Bash(ffmpeg:*, node:*, npm:*), mcp__ElevenLabs__text_to_sound_effects, WebFetch
```

## Tags

`audio` `retro` `windows` `90s` `ui-sounds`

## 🤝 Pairs Great With

- **[Windows 3 1 Web Designer](/docs/skills/windows_3_1_web_designer)**: Visual + audio Win31 experience
- **[Sound Engineer](/docs/skills/sound_engineer)**: Advanced audio processing
- **[Mobile Ux Optimizer](/docs/skills/mobile_ux_optimizer)**: Mobile haptic-audio coordination
