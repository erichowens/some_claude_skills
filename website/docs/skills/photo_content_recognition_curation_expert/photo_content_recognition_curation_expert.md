---
sidebar_label: Photo Content Recognition Curation Expert
sidebar_position: 1
---
...
- **[Event Detection Temporal Intelligence Expert](/docs/skills/event_detection_temporal_intelligence_expert)**: Temporal context for photos
- **[Wedding Immortalist](/docs/skills/wedding_immortalist)**: Curate wedding photo collections

## References

- [Content Detection Reference](./references/content-detection)
- [Face Recognition & Clustering Reference](./references/face-clustering)
- [Perceptual Hashing Implementation Reference](./references/perceptual-hashing)
- [Photo Indexing Pipeline Reference](./references/photo-indexing)
