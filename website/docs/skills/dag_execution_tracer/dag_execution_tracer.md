---
sidebar_label: Dag Execution Tracer
sidebar_position: 1
---
...
`dag` `observability` `tracing` `debugging` `logging`

## 🤝 Pairs Great With

- **[Dag Performance Profiler](/docs/skills/dag_performance_profiler)**: Provides timing data
- **[Dag Failure Analyzer](/docs/skills/dag_failure_analyzer)**: Provides failure context
- **[Dag Pattern Learner](/docs/skills/dag_pattern_learner)**: Provides execution patterns
- **[Dag Task Scheduler](/docs/skills/dag_task_scheduler)**: Traces scheduled tasks
