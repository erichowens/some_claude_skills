---
sidebar_label: Hand Drawn Infographic Creator
sidebar_position: 1
---
...
```
Read, Write, Edit, mcp__stability-ai__*, mcp__ideogram__*, WebFetch, WebSearch, mcp__firecrawl__*
```

## Tags

`infographics` `hand-drawn` `diagrams` `education` `recovery` `neuroscience` `AI-image-generation` `accessibility`

## References

- [Accessibility Standards for Hand-Drawn Infographics](./references/accessibility-standards)
- [AI Prompt Engineering for Hand-Drawn Infographics](./references/ai-prompt-engineering)
- [Anatomical Diagram Conventions](./references/anatomical-conventions)
- [Color Theory for Educational Graphics](./references/color-theory-education)
- [Composition Guidelines for Educational Diagrams](./references/composition-guidelines)
- [Line Drawing Techniques for Hand-Drawn Infographics](./references/line-drawing-techniques)
