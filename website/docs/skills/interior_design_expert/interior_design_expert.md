---
sidebar_label: Interior Design Expert
sidebar_position: 1
---
...
`interior` `lighting` `furniture` `space-planning` `color`

## 🤝 Pairs Great With

- **[Color Theory Palette Harmony Expert](/docs/skills/color_theory_palette_harmony_expert)**: Color decisions for interiors
- **[Fancy Yard Landscaper](/docs/skills/fancy_yard_landscaper)**: Indoor-outdoor cohesion

## References

- [Color Science for Interior Design](./references/color-science)
- [Lighting Design Reference (IES Standards)](./references/lighting-design)
- [Space Planning Mathematics](./references/space-planning)
- [Interior Design Style Guide](./references/style-guide)
