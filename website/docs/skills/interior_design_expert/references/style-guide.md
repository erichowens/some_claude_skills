...
└── Missing anchor colors → feels unfinished
```
...
5. Let architecture guide primary style
```
...
2010-present: Japandi, Maximalist revival, Biophilic
```
