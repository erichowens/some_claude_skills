---
sidebar_label: Dag Feedback Synthesizer
sidebar_position: 1
---
...
`dag` `feedback` `iteration` `guidance` `improvement`

## 🤝 Pairs Great With

- **[Dag Iteration Detector](/docs/skills/dag_iteration_detector)**: Receives iteration triggers
- **[Dag Convergence Monitor](/docs/skills/dag_convergence_monitor)**: Sends feedback for tracking
- **[Dag Output Validator](/docs/skills/dag_output_validator)**: Uses validation results
- **[Dag Confidence Scorer](/docs/skills/dag_confidence_scorer)**: Uses confidence breakdown
