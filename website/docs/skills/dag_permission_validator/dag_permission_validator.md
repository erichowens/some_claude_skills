---
sidebar_label: Dag Permission Validator
sidebar_position: 1
---
...
`dag` `permissions` `security` `validation` `inheritance`

## 🤝 Pairs Great With

- **[Dag Scope Enforcer](/docs/skills/dag_scope_enforcer)**: Validates before enforcement
- **[Dag Isolation Manager](/docs/skills/dag_isolation_manager)**: Validates isolation level permissions
- **[Dag Parallel Executor](/docs/skills/dag_parallel_executor)**: Validates before agent spawning
