---
sidebar_label: Speech Pathology Ai
sidebar_position: 1
---
...
- **[Voice Audio Engineer](/docs/skills/voice_audio_engineer)**: Voice synthesis for therapy
- **[Diagramming Expert](/docs/skills/diagramming_expert)**: Visualize articulation patterns

## References

- [Acoustic Analysis for Speech Pathology](./references/acoustic-analysis)
- [AI Models for Speech Pathology](./references/ai-models)
- [mellifluo.us Platform Integration](./references/mellifluo-platform)
- [Therapy Intervention Strategies](./references/therapy-interventions)
