---
sidebar_label: Dag Hallucination Detector
sidebar_position: 1
---
...
`dag` `quality` `hallucination` `fact-checking` `verification`

## 🤝 Pairs Great With

- **[Dag Output Validator](/docs/skills/dag_output_validator)**: Works with validation pipeline
- **[Dag Confidence Scorer](/docs/skills/dag_confidence_scorer)**: Low confidence triggers detection
- **[Dag Feedback Synthesizer](/docs/skills/dag_feedback_synthesizer)**: Reports hallucinations for feedback
