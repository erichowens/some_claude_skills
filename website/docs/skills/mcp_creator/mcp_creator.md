...
`mcp` `model-context-protocol` `tools` `integration` `servers`

## 🤝 Pairs Great With

- **[Agent Creator](/docs/skills/agent_creator)**: Skills that use the MCP tools
- **[Security Auditor](/docs/skills/security_auditor)**: Secure MCP server development

## References

- [MCP Architecture Patterns](./references/architecture-patterns)
- [MCP Security Hardening Guide](./references/security-hardening)
- [MCP Testing and Debugging Guide](./references/testing-debugging)
- [MCP Tool Design Patterns](./references/tool-design)
