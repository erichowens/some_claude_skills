...
`logging` `analytics` `metrics` `quality` `improvement`

## 🤝 Pairs Great With

- **[Automatic Stateful Prompt Improver](/docs/skills/automatic_stateful_prompt_improver)**: Data for prompt optimization
- **[Skill Coach](/docs/skills/skill_coach)**: Quality tracking feeds coaching
