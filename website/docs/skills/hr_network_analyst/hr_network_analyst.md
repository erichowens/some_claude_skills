---
sidebar_label: Hr Network Analyst
sidebar_position: 1
---
...
```
Read, Write, Edit, WebSearch, WebFetch, mcp__firecrawl__firecrawl_search, mcp__firecrawl__firecrawl_scrape, mcp__brave-search__brave_web_search, mcp__SequentialThinking__sequentialthinking
```

## Tags

`network` `superconnectors` `influence` `graph-theory` `hr`

## 🤝 Pairs Great With

- **[Career Biographer](/docs/skills/career_biographer)**: Understand network in career context
- **[Competitive Cartographer](/docs/skills/competitive_cartographer)**: Map competitive professional landscape

## References

- [Network Analysis Algorithms Reference](./references/algorithms)
- [Data Sources & Implementation Reference](./references/data-sources-implementation)
- [Professional Network Data Acquisition Guide](./references/data-sources)
- [Graph Database Analysis Reference](./references/graph-databases)
- [Network Theory Reference](./references/network-theory)
