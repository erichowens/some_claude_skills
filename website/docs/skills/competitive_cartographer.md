...
Find under-served positioning opportunities with these criteria:

**Good White Space Must Be:**
...
Provide specific, actionable positioning strategy including:
...
White space opportunities: "Engineer who explains technical decisions to non-technical stakeholders", "Specialist in legacy system modernization"

**SaaS Products:**
White space opportunities: "Opinionated tool that does one thing perfectly", "Integration layer between specific tools"

**Consulting/Freelance Services:**
White space opportunities: "Specialist in specific vertical/problem", "Productized service with fixed scope"
...
<InstallTabs skillId="competitive-cartographer" skillName="Competitive Cartographer" />
