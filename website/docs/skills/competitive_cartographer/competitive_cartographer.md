---
sidebar_label: Competitive Cartographer
sidebar_position: 1
---
...
`competitive-analysis` `market` `positioning` `strategy` `differentiation`

## 🤝 Pairs Great With

- **[Career Biographer](/docs/skills/career_biographer)**: Position career narratives competitively
- **[Research Analyst](/docs/skills/research_analyst)**: Deep market research backing

## References

- [Domain-Specific Positioning](./references/domain-positioning)
- [Competitive Mapping Process](./references/mapping-process)
- [Troubleshooting Guide](./references/troubleshooting)
