...
- **[Sound Engineer](/docs/skills/sound_engineer)**: Audio processing feeds the visualizations
- **[Metal Shader Expert](/docs/skills/metal_shader_expert)**: Advanced GPU shader techniques

## References

- [Butterchurn Integration Guide](./references/butterchurn-guide)
- [GLSL Shaders for Audio Visualization](./references/glsl-shaders)
- [Web Audio API FFT Reference](./references/web-audio-fft)
