---
sidebar_label: Dag Skill Registry
sidebar_position: 1
---
...
`dag` `registry` `skills` `catalog` `discovery`

## 🤝 Pairs Great With

- **[Dag Semantic Matcher](/docs/skills/dag_semantic_matcher)**: Provides skill catalog for matching
- **[Dag Capability Ranker](/docs/skills/dag_capability_ranker)**: Provides skill metadata for ranking
- **[Dag Graph Builder](/docs/skills/dag_graph_builder)**: Supplies skills for node assignment
