---
sidebar_label: Personal Finance Coach
sidebar_position: 1
---
...
`finance` `investing` `fire` `tax` `retirement`

## 🤝 Pairs Great With

- **[Indie Monetization Strategist](/docs/skills/indie_monetization_strategist)**: Monetization for wealth building
- **[Digital Estate Planner](/docs/skills/digital_estate_planner)**: Financial legacy planning

## References

- [Investment Theory](./references/investment-theory)
- [Tax Optimization Strategies](./references/tax-optimization)
- [Withdrawal Mathematics](./references/withdrawal-math)
