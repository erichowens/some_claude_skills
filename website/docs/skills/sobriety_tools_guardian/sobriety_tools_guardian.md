---
sidebar_label: Sobriety Tools Guardian
sidebar_position: 1
---
...
- [Crisis Detection Patterns for Recovery Apps](./references/CRISIS_DETECTION)
- [Performance Patterns for Recovery Apps](./references/PERFORMANCE_PATTERNS)
