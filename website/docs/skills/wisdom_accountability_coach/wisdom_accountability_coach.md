---
sidebar_label: Wisdom Accountability Coach
sidebar_position: 1
---
...
```
Read, Write, Edit, TodoWrite, mcp__firecrawl__firecrawl_search, mcp__brave-search__brave_web_search, WebFetch, mcp__SequentialThinking__sequentialthinking
```

## Tags

`accountability` `stoicism` `buddhism` `growth` `philosophy`

## 🤝 Pairs Great With

- **[Jungian Psychologist](/docs/skills/jungian_psychologist)**: Psychological depth for growth
- **[Adhd Daily Planner](/docs/skills/adhd_daily_planner)**: Daily accountability structure

## References

- [Conversation Scripts & Example Dialogues](./references/conversation-scripts)
- [Philosophy & Wisdom Traditions](./references/philosophy-traditions)
