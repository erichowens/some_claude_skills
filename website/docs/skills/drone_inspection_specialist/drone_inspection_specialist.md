...
```
Read, Write, Edit, Bash(python:*, pip:*), Grep, Glob, mcp__firecrawl__firecrawl_search, WebFetch, mcp__stability-ai__stability-ai-generate-image
```

## Tags

`inspection` `fire-detection` `thermal` `gaussian-splatting` `insurance`

## 🤝 Pairs Great With

- **[Drone Cv Expert](/docs/skills/drone_cv_expert)**: Core drone navigation and CV
- **[Clip Aware Embeddings](/docs/skills/clip_aware_embeddings)**: Semantic understanding of inspected areas

## References

- [Forest Fire Detection Reference](./references/fire-detection)
- [Gaussian Splatting 3D Reconstruction Reference](./references/gaussian-splatting-3d)
- [Insurance & Risk Assessment Reference](./references/insurance-risk-assessment)
- [Roof Inspection Reference](./references/roof-inspection)
