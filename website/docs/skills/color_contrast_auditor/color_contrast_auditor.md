---
sidebar_label: Color Contrast Auditor
sidebar_position: 1
---
...
```
Read, Write, Edit, WebFetch, Glob, Grep
```

## Tags

`accessibility` `wcag` `contrast` `color` `a11y` `visual-design`

## 🤝 Pairs Great With

- **[Web Design Expert](/docs/skills/web_design_expert)**: Implement accessible color fixes
- **[Ux Friction Analyzer](/docs/skills/ux_friction_analyzer)**: Broader accessibility context
- **[Design System Creator](/docs/skills/design_system_creator)**: Build accessible design tokens

## References

- [Pre-Calculated Safe Color Pairs](./references/safe-color-pairs)
