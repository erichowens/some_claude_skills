...
sidebar_label: Scoring Templates
sidebar_position: 2
---
# Scoring Templates
...
IDENTITY
  ...
  Anti-identity:         [Who they don't want to be seen as]
```

## Full Identity Fit Assessment
...
&lt;60:     Fundamental positioning problems
```
...
4. [Where delight happens - what creates it]
```
...
- Footer links broken: (10% × 4) / 2 = 20 → LOW PRIORITY
```
