---
sidebar_label: Product Appeal Analyzer
sidebar_position: 1
---
...
- **[Ux Friction Analyzer](/docs/skills/ux_friction_analyzer)**: Appeal asks "do they want it?" Friction asks "can they use it?" Use both.
- **[Competitive Cartographer](/docs/skills/competitive_cartographer)**: Position against alternatives with strategic mapping
- **[Web Design Expert](/docs/skills/web_design_expert)**: Implement visual identity recommendations

## References

- [Identity Signals Catalog](./references/identity-signals)
- [Objection Catalog](./references/objection-catalog)
- [Scoring Templates](./references/scoring-templates)
- [The Trust Ladder](./references/trust-ladder)
