---
sidebar_label: Recovery Social Features
sidebar_position: 1
---
...
- [Friend Connections](./references/friendships)
- [Meeting-Based Groups](./references/groups)
- [Safe Messaging](./references/messaging)
- [Safety & Moderation](./references/moderation)
- [Sponsor/Sponsee Implementation](./references/sponsor-sponsee)
