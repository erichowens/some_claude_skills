---
sidebar_label: Dag Task Scheduler
sidebar_position: 1
---
...
`dag` `orchestration` `scheduling` `parallelism` `resource-allocation`

## 🤝 Pairs Great With

- **[Dag Dependency Resolver](/docs/skills/dag_dependency_resolver)**: Uses topologically sorted waves
- **[Dag Parallel Executor](/docs/skills/dag_parallel_executor)**: Provides schedule for execution
- **[Dag Dynamic Replanner](/docs/skills/dag_dynamic_replanner)**: Supports dynamic rescheduling
