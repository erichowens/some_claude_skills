---
sidebar_label: Project Management Guru Adhd
sidebar_position: 1
---
...
```
Read, Write, Edit, TodoWrite, mcp__firecrawl__firecrawl_search, WebFetch, mcp__SequentialThinking__sequentialthinking
```

## Tags

`adhd` `project-management` `context-switching` `hyperfocus` `deadlines`

## 🤝 Pairs Great With

- **[Adhd Daily Planner](/docs/skills/adhd_daily_planner)**: Day-level planning within projects
- **[Orchestrator](/docs/skills/orchestrator)**: Coordinate multiple project streams

## References

- [Context Switching Management](./references/context-switching)
- [Hyperfocus Management](./references/hyperfocus-management)
- [Parakeet Reminder System](./references/parakeet-reminders)
- [Task Chunking for ADHD Brains](./references/task-chunking)
