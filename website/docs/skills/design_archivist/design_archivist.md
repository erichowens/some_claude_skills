---
sidebar_label: Design Archivist
sidebar_position: 1
---
...
`design-research` `patterns` `analysis` `visual-database` `trends`

## 🤝 Pairs Great With

- **[Web Design Expert](/docs/skills/web_design_expert)**: Apply researched patterns to designs
- **[Competitive Cartographer](/docs/skills/competitive_cartographer)**: Design-focused competitive analysis

## References

- [Design Archivist Data Structures](./references/data_structures)
- [Domain-Specific Research Guides](./references/domain_guides)
