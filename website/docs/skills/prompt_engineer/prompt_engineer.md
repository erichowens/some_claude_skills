...
```
Read, Write, Edit, Glob, Grep, mcp__SequentialThinking__sequentialthinking
```
...
- **[Ai Engineer](/docs/skills/ai_engineer)**: Apply optimized prompts in production LLM applications
- **[Automatic Stateful Prompt Improver](/docs/skills/automatic_stateful_prompt_improver)**: Automated prompt optimization with learning
