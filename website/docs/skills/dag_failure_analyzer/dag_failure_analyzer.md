---
sidebar_label: Dag Failure Analyzer
sidebar_position: 1
---
...
`dag` `observability` `debugging` `failures` `root-cause`

## 🤝 Pairs Great With

- **[Dag Execution Tracer](/docs/skills/dag_execution_tracer)**: Uses execution traces
- **[Dag Performance Profiler](/docs/skills/dag_performance_profiler)**: Correlates with performance data
- **[Dag Pattern Learner](/docs/skills/dag_pattern_learner)**: Provides failure patterns
- **[Dag Dynamic Replanner](/docs/skills/dag_dynamic_replanner)**: Informs recovery strategies
