...
- [Animation Patterns for Data Visualizations](./references/animation-patterns)
- [Data Storytelling: Turning Charts into Narratives](./references/data-storytelling)
- [React Data Visualization Libraries: Comprehensive Comparison (2025)](./references/library-comparison)
- [Testing Data Visualizations: Comprehensive Strategies](./references/testing-strategies)
- [Edward Tufte's Data Visualization Principles](./references/tufte-principles)
