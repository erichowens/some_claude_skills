---
sidebar_label: Maximalist Wall Decorator
sidebar_position: 1
---
...
```
Read, Write, Edit, mcp__stability-ai__stability-ai-generate-image, WebFetch
```

## Tags

`maximalist` `wall-decor` `bold` `gallery-wall` `eclectic`

## 🤝 Pairs Great With

- **[Interior Design Expert](/docs/skills/interior_design_expert)**: Room-scale design context
- **[Color Theory Palette Harmony Expert](/docs/skills/color_theory_palette_harmony_expert)**: Bold color theory

## References

- [Maximalist Color Combinations](./references/color-combinations)
