---
sidebar_label: Dag Semantic Matcher
sidebar_position: 1
---
...
`dag` `registry` `semantic-matching` `nlp` `discovery`

## 🤝 Pairs Great With

- **[Dag Skill Registry](/docs/skills/dag_skill_registry)**: Searches the skill catalog
- **[Dag Capability Ranker](/docs/skills/dag_capability_ranker)**: Ranks semantic matches
- **[Dag Graph Builder](/docs/skills/dag_graph_builder)**: Provides skills for node assignment
