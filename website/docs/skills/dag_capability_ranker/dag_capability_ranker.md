---
sidebar_label: Dag Capability Ranker
sidebar_position: 1
---
...
`dag` `registry` `ranking` `scoring` `optimization`

## 🤝 Pairs Great With

- **[Dag Semantic Matcher](/docs/skills/dag_semantic_matcher)**: Ranks matches from semantic search
- **[Dag Skill Registry](/docs/skills/dag_skill_registry)**: Uses performance data for ranking
- **[Dag Graph Builder](/docs/skills/dag_graph_builder)**: Provides ranked recommendations
