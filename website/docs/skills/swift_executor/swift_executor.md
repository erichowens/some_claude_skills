...
- **[Orchestrator](/docs/skills/orchestrator)**: Execute orchestrated tasks quickly
- **[Project Management Guru Adhd](/docs/skills/project_management_guru_adhd)**: Break through ADHD paralysis
