---
sidebar_label: Typography Expert
sidebar_position: 1
---
...
`typography` `fonts` `type-scale` `variable-fonts` `opentype`

## 🤝 Pairs Great With

- **[Design System Creator](/docs/skills/design_system_creator)**: Typography in design systems
- **[Web Design Expert](/docs/skills/web_design_expert)**: Typography for web projects
