---
sidebar_label: Hrv Alexithymia Expert
sidebar_position: 1
---
...
`hrv` `biofeedback` `interoception` `emotional-awareness` `vagal`

## 🤝 Pairs Great With

- **[Jungian Psychologist](/docs/skills/jungian_psychologist)**: Psychological context for HRV patterns
- **[Wisdom Accountability Coach](/docs/skills/wisdom_accountability_coach)**: Track emotional growth over time

## References

- [Alexithymia Assessment & Understanding](./references/alexithymia-assessment)
- [HRV Metrics Deep Dive](./references/hrv-metrics)
- [HRV Biofeedback & Interoception Training](./references/training-protocols)
