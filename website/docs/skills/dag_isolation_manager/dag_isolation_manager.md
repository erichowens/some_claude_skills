---
sidebar_label: Dag Isolation Manager
sidebar_position: 1
---
...
`dag` `permissions` `isolation` `sandboxing` `containment`

## 🤝 Pairs Great With

- **[Dag Permission Validator](/docs/skills/dag_permission_validator)**: Validates isolation-level permissions
- **[Dag Scope Enforcer](/docs/skills/dag_scope_enforcer)**: Enforces isolation boundaries
- **[Dag Parallel Executor](/docs/skills/dag_parallel_executor)**: Configures isolation for spawned agents
