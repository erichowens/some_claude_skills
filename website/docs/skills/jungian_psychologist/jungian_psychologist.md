---
sidebar_label: Jungian Psychologist
sidebar_position: 1
---
...
```
Read, Write, Edit, mcp__firecrawl__firecrawl_search, WebFetch, mcp__SequentialThinking__sequentialthinking
```

## Tags

`jung` `archetypes` `shadow` `dreams` `individuation`

## 🤝 Pairs Great With

- **[Wisdom Accountability Coach](/docs/skills/wisdom_accountability_coach)**: Accountability on growth journey
- **[Grief Companion](/docs/skills/grief_companion)**: Psychological depth for grief work

## References

- [Active Imagination: Protocols and Practice](./references/active-imagination)
- [Addiction & Recovery: A Jungian Framework](./references/addiction-recovery)
- [Clinical Frameworks](./references/clinical-frameworks)
- [Dream Interpretation in Jungian Psychology](./references/dream-interpretation)
- [Structure of the Psyche](./references/psyche-structure)
- [Skill Integration Protocols](./references/skill-integrations)
- [Jungian Symbol Dictionary](./references/symbol-dictionary)
- [Visual Mapping Methods for Jungian Work](./references/visual-mapping)
