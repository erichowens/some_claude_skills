---
sidebar_label: Data Pipeline Engineer
sidebar_position: 1
---
...
- **[Api Architect](/docs/skills/api_architect)**: APIs that consume pipeline data
- **[Devops Automator](/docs/skills/devops_automator)**: Orchestrate pipeline infrastructure

## References

- [dbt Project Structure Reference](./references/dbt-project-structure)
