---
sidebar_label: Real Time Collaboration Engine
sidebar_position: 1
---
...
- [Operational Transform vs CRDTs](./references/ot-vs-crdt)
- [Presence Awareness Patterns](./references/presence-patterns)
- [WebSocket Scaling Strategies](./references/websocket-scaling)
