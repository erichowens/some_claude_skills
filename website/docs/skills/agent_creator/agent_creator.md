...
```
Read, Write, Edit, Glob, Grep, Bash, mcp__firecrawl__firecrawl_search, WebFetch
```

## Tags

`agents` `mcp` `automation` `meta` `skill-development`

## 🤝 Pairs Great With

- **[Skill Coach](/docs/skills/skill_coach)**: Quality review for created skills
- **[Mcp Creator](/docs/skills/mcp_creator)**: When skills need external tool integration

## References

- [Agent Templates](./references/agent-templates)
- [Agent Creation Process](./references/creation-process)
- [MCP Integration](./references/mcp-integration)
