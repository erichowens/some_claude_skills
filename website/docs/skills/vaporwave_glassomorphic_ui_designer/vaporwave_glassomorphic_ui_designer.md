---
sidebar_label: Vaporwave Glassomorphic Ui Designer
sidebar_position: 1
---
...
```
Read, Write, Edit, mcp__magic__21st_magic_component_builder, mcp__magic__21st_magic_component_refiner, mcp__magic__21st_magic_component_inspiration, mcp__stability-ai__stability-ai-generate-image, mcp__firecrawl__firecrawl_search, WebFetch
```

## Tags

`vaporwave` `glassmorphism` `swiftui` `retro-futuristic` `neon`

## 🤝 Pairs Great With

- **[Native App Designer](/docs/skills/native_app_designer)**: Implement aesthetic in real apps
- **[Color Theory Palette Harmony Expert](/docs/skills/color_theory_palette_harmony_expert)**: Vaporwave color palettes

## References

- [Animations & Micro-Interactions](./references/animations-interactions)
- [Glassmorphism Patterns for SwiftUI](./references/glassmorphism-patterns)
- [Metal Shaders for Vaporwave Effects](./references/metal-shaders)
- [Vaporwave Aesthetic System](./references/vaporwave-aesthetic)
