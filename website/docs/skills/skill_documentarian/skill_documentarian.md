---
sidebar_label: Skill Documentarian
sidebar_position: 1
---

# ✍️ Skill Documentarian
...
`documentation` `skills` `sync` `artifacts` `metadata`

## 🤝 Pairs Great With

- **[Site Reliability Engineer](/docs/skills/site_reliability_engineer)**: Ensure docs build correctly
- **[Skill Coach](/docs/skills/skill_coach)**: Document quality skills

## References

- [Artifact Structure Reference](./references/artifact-structure)
- [Badge and Metadata Management Reference](./references/badge-metadata-management)
- [Documentation Templates Reference](./references/documentation-templates)
- [Tag Taxonomy Reference](./references/tag-taxonomy)
