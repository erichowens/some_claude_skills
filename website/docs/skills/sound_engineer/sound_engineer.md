...
```
Read, Write, Edit, Bash(python:*, node:*, npm:*, ffmpeg:*), mcp__firecrawl__firecrawl_search, WebFetch, mcp__ElevenLabs__text_to_sound_effects
```

## Tags

`audio` `spatial` `wwise` `fmod` `game-audio`

## 🤝 Pairs Great With

- **[Voice Audio Engineer](/docs/skills/voice_audio_engineer)**: Voice + spatial audio integration
- **[2000s Visualization Expert](/docs/skills/2000s_visualization_expert)**: Audio-reactive visuals

## References

- [Sound Engineering Implementation Reference](./references/implementations)
