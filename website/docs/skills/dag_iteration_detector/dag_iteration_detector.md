---
sidebar_label: Dag Iteration Detector
sidebar_position: 1
---
...
`dag` `feedback` `iteration` `refinement` `quality`

## 🤝 Pairs Great With

- **[Dag Feedback Synthesizer](/docs/skills/dag_feedback_synthesizer)**: Synthesizes feedback for iteration
- **[Dag Convergence Monitor](/docs/skills/dag_convergence_monitor)**: Tracks iteration progress
- **[Dag Output Validator](/docs/skills/dag_output_validator)**: Uses validation results
- **[Dag Confidence Scorer](/docs/skills/dag_confidence_scorer)**: Uses confidence thresholds
