...
`resume` `ats` `career` `pdf` `latex`

## 🤝 Pairs Great With

- **[Career Biographer](/docs/skills/career_biographer)**: Get structured career data
- **[Job Application Optimizer](/docs/skills/job_application_optimizer)**: Tailor CVs to specific roles

## References

- [Formatting Rules & Best Practices](./references/formatting-rules)
- [Interfaces & Integration Workflows](./references/interfaces-integration)
- [Resume Generation Protocol](./references/resume-protocol)
