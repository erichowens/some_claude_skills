---
sidebar_label: Adhd Design Expert
sidebar_position: 1
---
...
```
mcp__magic__21st_magic_component_builder, mcp__magic__21st_magic_component_refiner, mcp__stability-ai__stability-ai-generate-image, mcp__firecrawl__firecrawl_search, WebFetch, Read, Write, Edit
```

## Tags

`adhd` `ux` `accessibility` `neurodivergent` `cognitive-load`

## 🤝 Pairs Great With

- **[Native App Designer](/docs/skills/native_app_designer)**: Implement ADHD-friendly designs in apps
- **[Vaporwave Glassomorphic Ui Designer](/docs/skills/vaporwave_glassomorphic_ui_designer)**: Apply ADHD principles to aesthetic UI

## References

- [ADHD Design Patterns & Component Library](./references/patterns-and-components)
