---
sidebar_label: Automatic Stateful Prompt Improver
sidebar_position: 1
---
...
- **[Skill Coach](/docs/skills/skill_coach)**: Optimize skill prompts systematically
- **[Skill Logger](/docs/skills/skill_logger)**: Track prompt performance over time

## References

- [APE and OPRO Implementation Guide](./references/ape-opro-implementation)
- [DSPy Optimization Patterns for Prompt Learning](./references/dspy-patterns)
- [Embedding Architecture for Prompt Learning](./references/embedding-architecture)
- [Iteration Strategy](./references/iteration-strategy)
- [Learning Architecture](./references/learning-architecture)
- [MCP Server Specification: Prompt Learning Server](./references/mcp-server-spec)
- [Optimization Techniques](./references/optimization-techniques)
