...
- **[Devops Automator](/docs/skills/devops_automator)**: Secure deployment pipelines
- **[Mcp Creator](/docs/skills/mcp_creator)**: Secure MCP server development

## References

- [OWASP Top 10 2021 Reference Guide](./references/owasp-top-10-2024)
