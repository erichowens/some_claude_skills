---
sidebar_label: Career Biographer
sidebar_position: 1
---
...
`career` `narrative` `portfolio` `interviews` `storytelling`

## 🤝 Pairs Great With

- **[Cv Creator](/docs/skills/cv_creator)**: Turn career narratives into resumes
- **[Competitive Cartographer](/docs/skills/competitive_cartographer)**: Position your career competitively
