...
`discord` `telegram` `slack` `bots` `automation`

## 🤝 Pairs Great With

- **[Api Architect](/docs/skills/api_architect)**: Design robust bot backend APIs
- **[Devops Automator](/docs/skills/devops_automator)**: Deploy and scale bot infrastructure

## References

- [Architecture Patterns](./references/architecture-patterns)
- [Moderation System](./references/moderation-system)
- [Platform Templates](./references/platform-templates)
- [Rate Limiting (Production-Grade)](./references/rate-limiting)
